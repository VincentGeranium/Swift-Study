...
//  2019-05-14-UIViewAnimation-Study
//
//  Created by 김광준 on 14/05/2019.
...
final class ViewController: UIViewController {
    ...
    private func randomColorMaker() -> UIColor {
    ...
    private func makeMenuBtnWith(frame: CGRect, title: String) -> UIButton {
        let button = UIButton(frame: frame)
        button.backgroundColor = randomColorMaker()
    ...
    private func setupFirstMenu() {
        for i in (0..<UI.menuCount) {
            ...
            let button = makeMenuBtnWith(frame: menuFrame, title: "버튼 \(i)")
